...
//        }
        function MyMoodClass(thisMood)
        {
                ...
                //SetCookie("HishopAdminCookie",thisMood);
                //alert(getCookie("HishopAdminCookie"));
                document.getElementById("cssLink").href = "/GDZC/admin/css/IFrame_" + thisMood.toString() + ".css";
                parent.leftFrame.document.getElementById("cssLink").href = "/GDZC/admin/css/IFrame_" + thisMood.toString() + ".css";
                parent.contrlFrame.document.getElementById("cssLink").href = "/GDZC/admin/css/IFrame_" + thisMood.toString() + ".css";
        }
