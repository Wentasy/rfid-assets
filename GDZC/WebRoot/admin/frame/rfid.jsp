			...
			<tr>
				<td>
					<table width="100%" border="0" cellpadding="0" cellspacing="0"
						id="tree_menu">
                        <s:if test="#session.BlimitMap['RFID管理']!=null">
						<tr>
							<td id="tree_menu1"
								onclick="callLeftTree('tree_menu1');setplace('RFID管理 -> RFID管理');FrameRedirect('Main', '<%=path%>/admin/rfidAction!queryAllRfid.action?random='+Math.random());"
